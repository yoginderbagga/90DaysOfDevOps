...
Task 1: Review the ownership of the existing files and directory  
        ...
        b) verify the owner  
Task 2: Perform file owner changing operation  
...
Task 3: Perform the file group ownership changing operation  
        ...
        c) review the change.   
Task 4: Use chown to change the file owner and group with same command.    
